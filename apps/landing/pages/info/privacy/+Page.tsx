...
const MINECRAFT_SITE_DOMAIN = env.VITE_LANDING_ENDPOINT
  ...
  return (
    <MainWrapperPage variant="with_section">
      <div class="flex flex-col min-h-screen responsive mx-auto py-36 gap-y-6">
        <p class="text-3xl">Политика обработки персональных данных</p>
        <div class="flex flex-col gap-y-8 ">
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            <p class="text-xl">1. Общие положения</p>
          ...
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            ...
            <div class="flex flex-col text-md lg:text-lg gap-y-4">
              ...
              <p>
                ...
                а также программ для ЭВМ и баз данных,
              ...
              <p>
                ...
                раскрытие персональных данных неопределенному кругу
          ...
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            ...
            <div class="flex flex-col text-md lg:text-lg gap-y-4">
              <p>
                ...
                расположенные на сайте {MINECRAFT_SITE_DOMAIN}. Заполняя соответствующие формы
          ...
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            ...
            <div class="flex flex-col text-md lg:text-lg gap-y-4">
              ...
              <p>
                ...
                путем направления Оператору уведомление на адрес электронной почты Оператора {SUPPORT_EMAIL}
              ...
              <p>
                ...
                направив Оператору уведомление посредством электронной почты на электронный адрес Оператора {SUPPORT_EMAIL}
          ...
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            ...
            <div class="flex flex-col text-md lg:text-lg gap-y-4">
              ...
              <p>
                ...
                форме субъекта персональных данных на трансграничную передачу его персональных данных и/или исполнения договора,
          ...
          <div class="flex flex-col gap-y-4 border-2 border-[#454545] hover:duration-300 duration-300 rounded-[8px] p-4">
            ...
            <div class="flex flex-col text-md lg:text-lg gap-y-4">
              <p>
                ...
                обратившись к Оператору с помощью электронной почты {SUPPORT_EMAIL}.
              </p>
              <p>
